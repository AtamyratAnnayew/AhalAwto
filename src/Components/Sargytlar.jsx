    ...
    <>
      <div className="main">
        <div className="mainContainer px-10 flex flex-col gap-5">
          <div className="backButton cursor-pointer flex flex-row items-center gap-2" onClick={() => navigate('/')}>
            <img src={leftArrow} />
            <span className='text-xl font-semibold font-sans'>Yza gecmek</span>
          </div>
